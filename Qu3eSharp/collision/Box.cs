...
namespace Qu3e
{
	...
	public class Box
	{
		...
		public void SetSensor(bool isSensor) => sensor = isSensor;
		...
		private static readonly Vec3[] kBoxVertices = [
			new( -1, -1, -1 ),
			new( -1, -1,  1 ),
			new( -1,  1, -1 ),
			new( -1,  1,  1 ),
		...
		public void ComputeAABB(Transform tx, out AABB aabb)
		{
			...
			Vec3 max = new(-double.MaxValue, -double.MaxValue, -double.MaxValue);
		...
		//--------------------------------------------------------------------------------------------------
		private static readonly int[] kBoxIndices = {
				1 - 1, 7 - 1, 5 - 1,
				1 - 1, 3 - 1, 7 - 1,
				1 - 1, 4 - 1, 3 - 1,
				1 - 1, 2 - 1, 4 - 1,
	...
	public class BoxDef
	{
		...
		public void SetFriction(double friction) => Friction = friction;
		public void SetRestitution(double restitution) => Restitution = restitution;
		public void SetDensity(double density) => Density = density;
		public void SetSensor(bool sensor) => Sensor = sensor;
